...
(function() {
  ...
  function createProductCard(product) {
    ...
    priceContainer.style.minHeight = '48px'; // Fixed height for price container
    ...
    regularPrice.style.margin = '0 0 4px 0';
    ...
    discountPrice.style.fontSize = '1.2em';
  ...
  function loadProducts() {
    ...
    // Determine if we're on the subscription page
    const isSubscriptionPage = window.location.pathname.includes('subscription.html');
    const productType = isSubscriptionPage ? 'subscription' : 'product';
